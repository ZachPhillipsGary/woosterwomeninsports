...
?>
   <div class="dropdown">
    ...
    <button class="btn btn-default center-block dropdown-toggle" data-spy="affix" data-offset-top="0" type="button" id="exhibitMenu" data-toggle="dropdown">Menu<span class="caret"></span></button>
